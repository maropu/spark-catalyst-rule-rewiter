...
package org.apache.spark.sql.catalyst.ml.copied
 ...
 *
 * NOTE: This class was copied from `org.apache.spark.sql.catalyst.optimizer.StarSchemaDetection`
 * in Spark-v2.3.0.
 */
private[ml] object StarSchemaDetection extends PredicateHelper {
